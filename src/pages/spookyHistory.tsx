export default function SpookyHistory() {
  ...
  const histoyByLang = {
    es: `La Historia del Conde Costura Tenebrosa En las tierras lejanas de
      ...
      vivido para contar la historia de sus encuentros con él. El conde, en su
      vida mortal, había sido un sastre renombrado, capaz de confeccionar las
      prendas más deslumbrantes que cualquier noble podría desear. Se decía que
      su aguja y su hilo no solo cosían telas, sino que atrapaban sueños y
      ...
      moda: los practicantes de la magia oscura. Una noche, bajo una luna oscura
      ...
      extraño le pidió al conde crear un traje que lo volviera inmortal. A
      cambio, le ofreció un pacto: poderes sobrenaturales más allá de la
      comprensión humana. Atraído por la tentación, el Conde Costura aceptó el
      trato. El sastre trabajó durante semanas sin descanso, tejiendo su propio
      ...
      traje. El cliente misterioso, al ponerse la prenda, se desvaneció en el
      ...
      Conde Costura fue transformado en una criatura de la noche. Ya no era un
      ...
      telas encantadas que parecen moverse por sí solas. A los viajeros que se
      ...
      absorbidas por el conde, convirtiéndolos en marionetas vivientes. Se dice
      que el castillo del Conde Costura está lleno de sombras que cosen y
